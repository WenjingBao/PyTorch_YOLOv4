...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='IR\yolov4-IR-FLIR-2class-1channel.cfg', help='model.yaml path')
    parser.add_argument('--data', type=str, default='IR\FLIR.yaml', help='data.yaml path')
    ...
    parser.add_argument('--name', default='FLIR-IR-1ch-Person', help='save to project/name')
